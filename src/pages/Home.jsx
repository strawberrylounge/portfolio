      ...
      <section className="section section02">
        <div className="inner">
          ...
          <p className="section-contents-text">
            ...
            됩니다. 새로운 라이브러리는 늘 한 번쯤 찍먹은 해보고 싶은... 그래서
            프엔 개발자가... 살려주세요...
            <br />
            A. 기술의 논리와 디자인의 감성을 함께 이해하며, 사용자의 경험
            시각적으로 설계하고 아이디어를 코드로 구현합니다. 새로운 기술과
            패턴을 탐구하는 즐거움과 함께 끝없는 호기심으로 성장해왔습니다.
            도전을 두려워 하지 않으며 더 나은 흐름과 더 나은 경험을 찾아 웹의
            우주를 확장하고 있습니다.
            <br />
            B. 기술로 감각을 다루고, 디자인으로 논리를 세웁니다. 트렌드를
            따라가는 대신, 스스로 만들고 나만의 방식으로 재해석합니다. 기술과
            예술, 감각과 논리의 교차점에서 언제나 더 나은 결과를 만들어냅니다.
            새로운 언어, 새로운 툴, 새로운 프레임워크 - 호기심으로 시작하여
            도전의 과정을 거쳐 가장 완벽한 완성을 선보입니다.
            <br />
          </p>
        </div>
      </section>
